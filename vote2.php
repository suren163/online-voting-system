		...
		<form method="POST">
			...
			?>
				...
				<?php
					...
					$representative2 == $representative1  || $representative2 == $representative3
				) {
				?>
					<script type="text/javascript">
						alert('Same Representative is not aloud');
				...
				<?php
					...
					$representative3 == $representative1  || $representative3 == $representative2
				) {
				?>
					<script type="text/javascript">
						alert('Same Representative is not aloud');
				...
				<div class="ok_vote">
					...
					<div class="modal hide fade" id="myModal">
						...
						<div class="modal-body">
							<p>
								<font color="gray">Are You Sure you Want to Submit Final Votes?</font>
							</p>
						</div>
