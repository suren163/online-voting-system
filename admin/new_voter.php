					...
					<fieldset>
						<div class="pagination">
							<ul>
								...
								<li><a href="voter_list.php">
										<font color="white">All</font>
									</a></li>
								<li class=""><a href="Voted_voters.php">
										<font color="white">Voted Voters</font>
									</a></li>
								<li class=""><a href="Unvoted_voters.php">
										<font color="white">UnVoted Voters</font>
									</a></li>
								<li class="active"><a href="new_voter.php">
										<font color="white"><i class="icon-plus icon-large"></i>Add Voters</font>
									</a></li>
							...
							<ul class="thumbnails_new_voter">
								<li class="span3">
									<div class="thumbnail_new_voter">
										...
										<div class="control-group">
											<label class="control-label" for="input01">D no:</label>
											<div class="controls">
